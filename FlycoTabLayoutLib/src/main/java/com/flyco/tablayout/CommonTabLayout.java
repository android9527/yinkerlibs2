...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mDividerWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_width, dp2px(1));//每个tab之间的竖线宽度
        mDividerPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_divider_padding, dp2px(5));//竖线距离上下的padding

        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(10f));
        ...
        mIconWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_iconWidth, dp2px(42));//icon的宽高
        mIconHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_iconHeight, dp2px(42));
        mIconMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_iconMargin, dp2px(0.5f));
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            //FIXME tab上的icon距离上方的距离
            tabView.setPadding((int) mTabPadding, dp2px(2f), (int) mTabPadding, 0);
            TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
...
//            tabView.setBackgroundColor(isSelect?Color.parseColor("#CBCBCB"):Color.parseColor("#FDFDFE"));
        }
    }
    ...
    public void showMsg(int position, int num) {
        ...
        if (tipView != null) {
            ...
            if (!mIconVisible) {
                ...
                //FIXME  设置小红点位置
                setMsgMargin(position, -1,
                        mIconGravity == Gravity.LEFT || mIconGravity == Gravity.RIGHT ? 4 : dp2px(0f));
            }
