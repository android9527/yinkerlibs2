 ...
 *
 */
public class YKToggleButton extends View{
	...
	private YKToggleButton(Context context) {
		super(context);
	}
	public YKToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		setup(attrs);
	}
	public YKToggleButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		setup(attrs);
	}
	...
	public void setup(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.YKToggleButton);
		offBorderColor = typedArray.getColor(R.styleable.YKToggleButton_offBorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.YKToggleButton_onColor, onColor);
		spotColor = typedArray.getColor(R.styleable.YKToggleButton_spotColor, spotColor);
		offColor = typedArray.getColor(R.styleable.YKToggleButton_offColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.YKToggleButton_borderWidth, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.YKToggleButton_animate, defaultAnimate);
		typedArray.recycle();
	...
	public interface OnToggleChanged{
		 ...
		 * @param on
		 */
        void onToggle(YKToggleButton toggleButton, boolean on);
	}
